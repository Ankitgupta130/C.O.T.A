          ...
          .then((url2) => {
            ...
            storage
              ...
              .then((url3) => {
                //forth image
                storage
                  .ref("/images/" + image4.name)
                  .put(image4)
                  .on(
                    "state_changed",
                    alert("Data is uploaded successfuly"),
                    alert,
                    () => {
                      storage
                        .ref("images")
    ...
    if (otp.length === 6) {
      ...
      confirmationResult
        ...
        .then((result) => {
          ...
          console.log(user);
          alert("OTP verified!!.  Please Click on Add Room Button.");
          // ...
        })
        .catch((error) => {
  ...
  return (
    <React.Fragment>
      ...
      <div style={{ textAlign: "center" }}>
        ...
        <br />
        <Typography sx={{ padding: "5px" }} variant="h5" component="div">
          Upload Room Images
        </Typography>
        <br />
        <input
      ...
      >
        ...
        <button
          className="button-21"
          onClick={isAuthenticated ? handleSend : () => loginWithRedirect()}
          style={{
            display: "flex",
            alignItems: "center",
